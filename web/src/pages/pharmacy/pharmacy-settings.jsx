// src/pages/pharmacy/pharmacy-settings.jsx
...
/* localStorage helpers so settings persist only for the pharmacy user locally */
...
export default function PharmacySettings() {
    ...
    // notification toggle (scoped to this pharmacy user)
